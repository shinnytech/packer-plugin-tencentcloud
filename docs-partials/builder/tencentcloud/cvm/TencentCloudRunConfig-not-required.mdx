...
- `security_service_enabled` (bool) - Security Service Enabled

- `monitor_service_enabled` (bool) - Monitor Service Enabled

- `automation_service_enabled` (bool) - Automation Service Enabled
